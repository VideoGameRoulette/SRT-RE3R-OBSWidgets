...
function appendData(data) {
	...
	if (data.PlayerPoisoned)
		mainContainer.innerHTML += `<img src="img/POISON.gif"/><font size="4" color="#7851a9"><div id="currenthp">${data.PlayerCurrentHealth}</div></font>`;
	//Fine
	else if (data.PlayerCurrentHealth <= 1200 && data.PlayerCurrentHealth >= 801)
		mainContainer.innerHTML += `<img src="https://cdn.discordapp.com/attachments/551840398016774193/699457929769779230/FINE.gif"/><font size="4" color="#7cfc00"><div id="currenthp">${data.PlayerCurrentHealth}</div></font>`;
	//Caution!
	else if (data.PlayerCurrentHealth <= 800 && data.PlayerCurrentHealth >= 361)
		mainContainer.innerHTML += `<img src="img/CAUTION-YELLOW.gif"/><font size="4" color="#daa520"><div id="currenthp">${data.PlayerCurrentHealth}</div></font>`;
	//Dangerops!
	else if (data.PlayerCurrentHealth <= 360 && data.PlayerCurrentHealth >= 1)
		mainContainer.innerHTML += `<img src="img/DANGER.gif"/><font size="4" color="#ff0000"><div id="currenthp">${data.PlayerCurrentHealth}</div></font>`;
	//Default
	else
		mainContainer.innerHTML += `<img src="img/EMPTY.gif"/><font size="4" color="#ff0000"><div id="currenthp">${data.PlayerCurrentHealth}</div></font>`;
